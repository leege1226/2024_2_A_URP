...
public class MeshTrail : MonoBehaviour
{
    ...
    public float speedBoost = 6;        //잔상 효과
    ...
    public string shaderVarRef;                       //셰이더에서 사용할 변수 이름
    public float shaderVarRate = 0.1f;                //셰이더 효과 변화 속도
    public float shaderVarRefreshRate = 0.05f;       //셰이더 효과가 업데이트 되는 시간 간격

    private SkinnedMeshRenderer[] skinnedRenderer;      //캐릭터 3D 모델을 렌더링 하는 컴포넌트들
    private bool isTrailActive;                         //현재 잔상 효과가 활성화되어 있는지 확인하는 변수

    private float normalSpeed;          //원래 이동 속도 저장하는 변수
